...
var herostartnum = 123;
var nowrings = 20;
var herostartrings = nowrings + heronames.length + 1;
var rings = new Array(
    new Array(//0 start
        new Array("#"+Players.GetPlayerSelectedHero(Game.GetLocalPlayerID()),"#announcers","#favourites","#heroes","#misc","#meme","#dotaplus2","#dotaplus"),
    ...
    new Array(//13 announcers
        new Array("#englishannouncer","#chineseannouncer","#russianannouncer","#truesight","","","#epiccaster","#koreancaster"),
        new Array(false,false,false,false,false,false,false,false),
        new Array(6,2,3,19,0,0,15,17)
    ),
    new Array(//14 meme
        new Array("#youre_already_dead","#nani","#ayaya","","","","",""),
        new Array(true,true,true,false,false,false,false,false),
        new Array(70,71,72,0,0,0,0,0)
    ),
    ...
    new Array(//19 Truesight
        new Array("#truesight2","#321_lets_go","#did_we_actually_win","#every_game_like_the_last","#ive_won_the_international","#keyboard_not_working","#moolah","#no_more_tips"),
        new Array(false,true,true,true,true,true,true,true),
        new Array(20,101,102,103,104,105,106,107)
    ),
    new Array(//20 Truesight2
        new Array("#snail_walks_into_a_bar","#sounds_good","#stupidest_way_to_die","#such_a_smart_idea","#youre_damn_crazy","","",""),
        new Array(true,true,true,true,true,false,false,false),
        new Array(108,109,110,111,112,0,0,0)
    )
);
...
function StartWheel() {
    if (GameUI.IsControlDown()) {
        Game.SecondaryAbility.OnSecondaryAbilityActivated(0, false);
    } else {
        $("#Wheel").visible = true;
        $("#Bubble").visible = true;
...
(function() {
    ...
    GameUI.SetKeyBinding("L", "WheelButton", StartWheel, true, StopWheel);
