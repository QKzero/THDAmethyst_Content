...
//--------------------------------------------------------------------------------------------------
// Update teamNodes for sync SetCustomGameTeamMaxPlayers
//--------------------------------------------------------------------------------------------------
function updateTeamNodes()
{
	...
	{
		var playerPanel = g_PlayerPanels[ i ];
		playerPanel.SetParent( $( "#UnassignedPlayersContainer" ) );
	}
...
(function()
{
	...
	// 手动更新
	GameEvents.Subscribe("thd_team_select_update", updateTeamNodes);
})();
